...
class Solution {
    public static void main(String[] args) {
        ...
        try (Scanner sc = new Scanner(System.in)) {
            ...
            // Update subject material to "copper" with density 8500.0
            material = new Material("copper", 8500.0);
            subject.setMaterial(material);
            // Output the mass of the updated subject to 2 decimal places
